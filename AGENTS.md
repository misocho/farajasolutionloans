...
- Routers: `auth`, `admin`, `loans_clients` (clients, loans, installments, repayments, dashboard stats), `branches`, `reports`, `notifications`, `search`, `fees`, `seed`, `expenses` (added 2026-08-17).
